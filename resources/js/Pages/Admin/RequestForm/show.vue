                    ...
                    <div class="p-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p><span>Status:</span>
                                        <span :class="['badge', badgeClass, 'ms-2']">{{ referral?.status }}</span>
                                    </p>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="p-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p><span>Social Security Number:</span> {{ referral?.claimant_information?.ssn }}
                                    </p>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <p><span>Other Language:</span> {{ referral?.claimant_information?.other_language }}
                                    </p>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <p><span>Date of Accident/ Injury:</span> {{
                                        referral?.claimant_information?.accident_date }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Injury Description:</span> {{
                                        referral?.claimant_information?.injury_description }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Background of Injury:</span> {{
                                        referral?.claimant_information?.injury_background }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Currently Working:</span> {{
                                        referral?.claimant_information?.currently_working ===1? 'Yes':'No' }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Claim Accepted:</span> {{ referral?.claimant_information?.claim_accepted
                                        ===1? 'Yes':'No' }}</p>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <p><span>Type of Service:</span> {{ referral?.claimant_information?.service?.name }}
                                    </p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Other,Service:</span> {{ referral?.claimant_information?.other_claim_type
                                        }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Insured/Carrier:</span> {{ referral?.claimant_information?.insured_carrier
                                        }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>AMA 4th Edition:</span> {{ referral?.claimant_information?.ama_4th === 1 ?
                                        'Yes':'No' }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>AMA 5th Edition:</span> {{ referral?.claimant_information?.ama_5th === 1 ?
                                        'Yes':'No' }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>AMA 6th Edition:</span> {{ referral?.claimant_information?.ama_6th === 1 ?
                                        'Yes':'No'}}</p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <p><span>Transportation:</span> {{ referral?.claimant_information?.transportation
                                        ===1? 'Yes':'No' }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Translation:</span> {{ referral?.claimant_information?.translation === 1 ?
                                        'Yes':'No' }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Conference Call:</span> {{
                                        referral?.claimant_information?.conference_call===1? 'Yes':'No' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6" v-if="claimTypeId == 1 || claimTypeId == 2 || claimTypeId == 7">
                                    <p><span class="fw-bold">Causal relationship between injury and current
                                            complaints :</span>
                                        {{ referral?.issues_and_items_to_address?.injury_causal_relationship === 1 ?
                                        'Yes':'No' }}</p>
                                </div>

                                <div class="col-md-6" v-if="claimTypeId == 2 || claimTypeId == 7">
                                    <p><span class="fw-bold">Please explain how the accident would have caused the
                                            patient's
                                            complaints :</span>
                                        {{ referral?.issues_and_items_to_address?.explain_cause_of_complaints === 1 ?
                                        'Yes':'No' }}</p>
                                </div>

                                <div class="col-md-6" v-if="claimTypeId == 2">
                                    <p><span class="fw-bold">Does the claimant have any activity restrictions :</span>
                                        {{ referral?.issues_and_items_to_address?.activity_restrictions === 1 ? 'Yes' : 'No'
                                        }}</p>
                                </div>

                                <div class="col-md-6"
                                    v-if="claimTypeId == 1 || claimTypeId == 2 || claimTypeId == 7 || claimTypeId == 8">
                                    <p><span class="fw-bold">Is current treatment reasonable and necessary :</span>
                                        {{ referral?.issues_and_items_to_address?.is_current_treatment_necessary === 1 ?
                                        'Yes':'No' }}</p>
                                </div>

                                <div class="col-md-6"
                                    v-if="claimTypeId == 1 || claimTypeId == 2 || claimTypeId == 7 || claimTypeId == 8">
                                    <p><span class="fw-bold">Is further treatment needed? If so, what kind, for what
                                            length,
                                            and at what frequency:</span>
                                        {{ referral?.issues_and_items_to_address?.further_treatment_needed === 1 ?
                                        'Yes':'No' }}</p>
                                </div>
                                ...
                                <div class="col-md-6"
                                    ...
                                    <p><span class="fw-bold">Causal relationship between injury and current complaints?
                                            Please explain how the accident would have caused the patients'
                                            complaints:</span>
                                        {{ referral?.issues_and_items_to_address?.is_causal_relationship_explained === 1 ?
                                        'Yes':'No' }}</p>
                                </div>

                                <!-- General Liability -->
                                <div class="col-md-6" v-if="claimTypeId == 1 || claimTypeId == 6 || claimTypeId == 8">
                                    <p><span class="fw-bold">Did the claimant sustain any permanent injury as a result
                                            of
                                            this accident? If not, please indicate this in your report:</span>
                                        {{ referral?.issues_and_items_to_address?.sustained_permanent_injury === 1 ?
                                        'Yes':'No' }}</p>
                                </div>
                                ...
                                <div class="col-md-6" v-if="claimTypeId == 1 || claimTypeId == 6 || claimTypeId == 8">
                                    <p><span class="fw-bold">Can claimant return to work at this time with no
                                            restrictions :</span>
                                        {{ referral?.issues_and_items_to_address?.return_to_work_no_restrictions === 1 ?
                                        'Yes':'No' }}</p>
                                </div>
                                <div class="col-md-6" v-if="claimTypeId == 7">
                                    <p><span class="fw-bold">What are claimant's physical capabilities? :</span>
                                        {{ referral?.issues_and_items_to_address?.physical_capabilities === 1 ? 'Yes' : 'No'
                                        }}</p>
                                </div>
                    ...
                    <div class="p-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p><span>Contact for Input:</span> {{ referral?.defense_attorney?.contact_for_input
                                        ===1? 'Yes':'No' }}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p><span>Appointment Date:</span> {{
                                        referral?.appointment_information?.appointment_date }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Time:</span> {{ referral?.appointment_information?.appointment_time }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Report Completed By:</span> {{
                                        referral?.appointment_information?.report_completed_by }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Reason For Report Rush Date:</span> {{ referral?.appointment_information?.
                                        reason_report_rush_date }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>X-Rays Approved:</span> {{
                                        referral?.appointment_information?.x_rays_approved ===1? 'Yes':'No' }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span>Special Instructions / Price Restrictions:</span> {{
                                        referral?.appointment_information?.special_instructions }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-header sub-well">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <p><span> Copy to Claimant's Attorney:</span>
                                        {{ referral?.appointment_information?.copy_to_claimant_attorney === 1 ? 'Yes' : 'No'
                                        }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span> Copy to Defense Attorney:</span>
                                        {{ referral?.appointment_information?.copy_to_defense_attorney === 1 ? 'Yes' : 'No'
                                        }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span> Copy to Referring Party:</span>{{
                                        referral?.appointment_information?.copy_to_referring_party ===1? 'Yes':'No' }}
                                    </p>
                                </div>
                                <div class="col-md-4">
                                    <p><span> Copy to Billing Party:</span> {{
                                        referral?.appointment_information?.copy_to_billing_party ===1? 'Yes':'No' }}</p>
                                </div>
                                <div class="col-md-4">
                                    <p><span> Do Not Send Notifications:</span> {{
                                        referral?.appointment_information?.do_not_send_notifications ===1? 'Yes':'No' }}
                                    </p>
                                </div>
